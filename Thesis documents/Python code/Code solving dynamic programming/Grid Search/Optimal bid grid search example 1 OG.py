...
# Define search grid for bid (b) and price (p)
bid_grid = np.linspace(0.01, 2.0, 100)
price_grid = np.linspace(0.01, 4.0, 100)

# Initialize profit and bid matrices
...
# Dynamic programming with grid search
